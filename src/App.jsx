  ...
  const STEPS = [
    ...
    },
    {
      ...
      steps: [
        ...
        { action: "Once logged in, click your avatar in the top right corner." },
        { action: "Click API in the dropdown menu." },
        { action: 'Your API key is shown there — format looks like: CJ123456@api@xxxxxxxxxx' },
