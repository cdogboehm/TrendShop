...
// ─── Most-searched TikTok Shop product hashtags (data-backed, March 2026) ─────
// Sources: Shopify, FindNiche, LitCommerce, TikTok Creative Center
const PRODUCT_SEARCHES = [
  // Beauty — biggest TikTok Shop category
  { tag:"TikTokMadeMeBuyIt", category:"beauty"    }, // billions of views, prime shopping signal
  { tag:"NailArt",           category:"beauty"    }, // 50B+ views, huge purchase intent
  { tag:"LipOil",            category:"beauty"    }, // consistently viral, impulse buy
  { tag:"GlowUp",            category:"skincare"  }, // transformation content = buy signal
  { tag:"SkincareRoutine",   category:"skincare"  }, // 10B+ views, daily repurchase
  { tag:"GuaSha",            category:"skincare"  }, // viral tool category
  // Home & Lighting — visual = viral
  { tag:"RoomDecor",         category:"home"      }, // massive, evergreen
  { tag:"LedLights",         category:"home"      }, // 8B+ views, cheap + visual
  { tag:"CleanTok",          category:"kitchen"   }, // 10B+ views, cleaning products
  { tag:"GalaxyProjector",   category:"home"      }, // LED category breakout product
  // Drinkware — Stanley effect still strong
  { tag:"WaterBottle",       category:"drinkware" }, // billions of views
  { tag:"StanleyTumbler",    category:"drinkware" }, // ongoing dupe market
  // Kitchen — AirFryer never dies
  { tag:"AirFryer",          category:"kitchen"   }, // 3B+ views
  { tag:"KitchenGadgets",    category:"kitchen"   }, // broad but high-intent
  // Fashion
  { tag:"OOTD",              category:"fashion"   }, // 100B+ views, consistent
  { tag:"CasualDresses",     category:"fashion"   }, // 3.4M posts, spike each season
  // Wellness & Health
  { tag:"ColdPlunge",        category:"wellness"  }, // fast-growing, high margin
  { tag:"Supplements",       category:"health"    }, // broad high-volume
  // Fitness
  { tag:"HomeWorkout",       category:"fitness"   }, // evergreen, high intent
  // Pet
  { tag:"PetTok",            category:"pet"       }, // 20B+ views
  // Tech/Phone
  { tag:"PhoneCase",         category:"tech"      }, // 2.5M posts, impulse buy
  { tag:"PhoneAccessories",  category:"tech"      }, // broad tech category
];
...
const Landing = ({ onEnter }) => {
  ...
  return (
    <div style={{ minHeight:"100vh", background:C.bgBase, overflowX:"hidden" }}>
      ...
      {/* Nav */}
      <nav style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"16px 24px", borderBottom:`1px solid ${C.border}`, position:"sticky", top:0, background:`${C.bgBase}f0`, backdropFilter:"blur(12px)", zIndex:100 }}>
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          <div>
            ...
            <p style={{ fontSize:11, color:C.text3, marginTop:6 }}>
              {apiProvider==="scrapecreators"?<>Free key: <a href="https://app.scrapecreators.com" target="_blank" rel="noreferrer">app.scrapecreators.com</a></>:
               apiProvider==="rapidapi_scraper7"?<>Get key: <a href="https://rapidapi.com/tikwm-tikwm-default/api/tiktok-scraper7" target="_blank" rel="noreferrer">rapidapi.com — TikTok Scraper7</a></>:
               apiProvider==="rapidapi_data"?<>Get key: <a href="https://rapidapi.com" target="_blank" rel="noreferrer">rapidapi.com — search "TikTok Data API"</a></>:
...
const GuideTab = ({ setTab }) => {
  ...
  return (
    <div style={{ maxWidth:680, padding:"32px 0" }}>
